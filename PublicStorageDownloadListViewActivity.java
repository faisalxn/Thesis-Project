...
public class PublicStorageDownloadListViewActivity extends AppCompatActivity {

    Toolbar toolbar ;
    RecyclerView public_all_files ;
    FirebaseAuth mAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_public_storage_download_list_view);

        companyId = getIntent().getStringExtra("companyId");

        toolbar = (Toolbar) findViewById(R.id.public_download_toolbar);
        public_all_files = (RecyclerView) findViewById(R.id.public_all_files);

        mAuth = FirebaseAuth.getInstance();
        uId = mAuth.getCurrentUser().getUid();

        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Public storage");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);


        fileNameRef = FirebaseDatabase.getInstance().getReference().child("URLs").child(companyId).child("public_files");

        mLayoutManager = new LinearLayoutManager(this);
        mLayoutManager.setReverseLayout(true);
        mLayoutManager.setStackFromEnd(true);

        public_all_files.setHasFixedSize(true);
        public_all_files.setLayoutManager(mLayoutManager);
    ...
    private void logoutUser() {
        Intent intent = new Intent(PublicStorageDownloadListViewActivity.this,WelcomeActivity.class);
    ...
    protected void onStart() {
        ...
        public_all_files.setAdapter(firebaseRecyclerAdapter);
    }
    ...
    private void downloadFile(String fileName) {
        ...
        storageFileRef = storageRef.child(companyId).child("public_storage").child(fileName);
        String directory = "project/public_files";
        ...
        storageFileRef.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
            ...
            public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                //Log.e()
                Toast.makeText(PublicStorageDownloadListViewActivity.this,
